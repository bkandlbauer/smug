...
const [last, setLast] = useState(34);
...
const connectBLE = async () => {
  ...
  return (
      ...
      <button onClick={connectBLE} className="cursor-pointer mt-30  px-15 py-3 bg-black text-white rounded flex items-start hover:bg-white hover:text-black hover:border-1 duration-100 ease-in-out">
        Connect
      </button>
    </div>
  )
